...
// Bonds: lines between nearby particles (position in -1..1, same as particles)
export const BONDS_VERTEX_SHADER = `#version 300 es
precision highp float;
in vec2 a_position;
in vec3 a_color;
out vec3 v_color;
...
export const BONDS_FRAGMENT_SHADER = `#version 300 es
precision highp float;
in vec3 v_color;
