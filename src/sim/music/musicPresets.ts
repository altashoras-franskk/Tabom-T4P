...
export const MUSIC_PRESETS: MusicPreset[] = [
  ...
  // motionStyle: drift — particles float like pollen. Few gates, low event rate.
  {
    ...
    particleGlow:2.2, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // Orbital particles singing in vast reverb. Lydian harmonic halos.
  {
    ...
    harmonyMode:'consonant',
    particleGlow:2.8, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // Ultra-slow meditation physics. Particles barely move. Each note is precious.
  {
    ...
    harmonyMode:'consonant',
    particleGlow:3.0, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // School-of-fish motion, detuned sine layers = subaquatic pressure.
  {
    ...
    harmonyMode:'consonant',
    particleGlow:1.8, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // Lattice motion — particles snap to grid. Triangle arps shimmer like crystal.
  {
    ...
    harmonyMode:'consonant',
    particleGlow:1.2, trailLen:0, lens:'Notes', bgPulse:false, cinematic:false,
  ...
  // Spiral physics — particles draw mandalas. Deep drones + overtones.
  {
    ...
    harmonyMode:'modal',
    particleGlow:2.5, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // Migration physics — particles stream like northern lights. Whole tone mystery.
  {
    ...
    harmonyMode:'free',
    particleGlow:2.4, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // Swarm physics — tight cluster bursts on gate crossings. 4/4 emergent.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.4, trailLen:0, lens:'Rhythm', bgPulse:true, cinematic:true,
  ...
  // Drift physics — particles wander lazily. Click percussion + groove swing.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.0, trailLen:0, lens:'Rhythm', bgPulse:false, cinematic:false,
  ...
  // Murmuration physics — 303 lines slide with flock velocity. High resonance.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.6, trailLen:0, lens:'Rhythm', bgPulse:true, cinematic:true,
  ...
  // Dance physics — pairs orbit each other. Chord stabs between partners.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.3, trailLen:0, lens:'Harmony', bgPulse:true, cinematic:false,
  ...
  // Chaos physics — brownian motion creates unpredictable rhythms. High energy.
  {
    ...
    harmonyMode:'free',
    particleGlow:1.5, trailLen:0, lens:'Rhythm', bgPulse:true, cinematic:true,
  ...
  // Organism physics — breathing cluster. Deep delay + reverb wash.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.6, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // Drift physics — gentle wandering. Sparse piano-like tones in lydian.
  {
    ...
    harmonyMode:'consonant',
    particleGlow:1.5, trailLen:0, lens:'Notes', bgPulse:false, cinematic:true,
  ...
  // Jazz physics — small clusters form and dissolve. Plucked string textures.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.0, trailLen:0, lens:'Notes', bgPulse:false, cinematic:false,
  ...
  // Jazz physics — microcluster improvisation. Modal voicings + brush percussion.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.3, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // War physics — two armies of sound colliding. Chromatic freedom.
  {
    ...
    harmonyMode:'free',
    particleGlow:1.5, trailLen:0, lens:'Tension', bgPulse:true, cinematic:true,
  ...
  // Ballistic physics with gravity. Particles fall and bounce, creating rhythm.
  {
    ...
    harmonyMode:'consonant',
    particleGlow:1.3, trailLen:0, lens:'Notes', bgPulse:false, cinematic:false,
  ...
  // Full murmuration with all 8 roles — the flock IS the orchestra.
  {
    ...
    harmonyMode:'consonant',
    particleGlow:1.5, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // Organism physics — mass breathes. Pressure creates rhythm, release creates melody.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.8, trailLen:0, lens:'Events', bgPulse:false, cinematic:true,
  ...
  // Predation physics — roles chase/flee. Musical tension from pursuit.
  {
    ...
    particleGlow:1.4, trailLen:0, lens:'Tension', bgPulse:true, cinematic:true,
  ...
  // Exodus physics — mass fleeing. Notes fire as the swarm crosses gates.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.6, trailLen:0, lens:'Events', bgPulse:false, cinematic:true,
  ...
  // Polarization physics — two harmonic poles emerge. Consonance vs dissonance.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.8, trailLen:0, lens:'Tension', bgPulse:false, cinematic:true,
  ...
  // Explosion physics — burst/regroup cycles. Each expansion spawns melodic debris.
  {
    ...
    harmonyMode:'free',
    particleGlow:1.8, trailLen:0, lens:'Events', bgPulse:true, cinematic:true,
  ...
  // Spiral physics — slow unwinding like a raga. Phrygian drone tanpura.
  {
    ...
    harmonyMode:'modal',
    particleGlow:2.0, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // Lattice physics — grid snapping like metalophone keys. Slendro-like scale.
  {
    ...
    harmonyMode:'consonant',
    particleGlow:1.4, trailLen:0, lens:'Notes', bgPulse:false, cinematic:false,
  ...
  // Revolution physics — spiraling intensity like a flamenco buildup.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.3, trailLen:0, lens:'Rhythm', bgPulse:true, cinematic:true,
  ...
  // Migration physics — desert caravan. Blues scale + pentatonic groove.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.2, trailLen:0, lens:'Harmony', bgPulse:false, cinematic:true,
  ...
  // Predation + high mutation. Roles evolve over time. Musical Darwinism.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.5, trailLen:0, lens:'Events', bgPulse:false, cinematic:true,
  ...
  // Cells physics — organic pulsing clusters. Chromatic tension. Dissonant.
  {
    ...
    harmonyMode:'dissonant',
    particleGlow:2.2, trailLen:0, lens:'Tension', bgPulse:false, cinematic:true,
  ...
  // Fast particles with many gates. Every crossing = note. Portal physics.
  {
    ...
    harmonyMode:'free',
    particleGlow:1.2, trailLen:0, lens:'Notes', bgPulse:true, cinematic:false,
  ...
  // Carnival physics — 3 vortices at different speeds. Complex rhythmic ratios.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.3, trailLen:0, lens:'Rhythm', bgPulse:true, cinematic:false,
  ...
  // One single particle wandering. Each gate crossing is a solo performance.
  {
    ...
    harmonyMode:'consonant',
    particleGlow:3.0, trailLen:0, lens:'Notes', bgPulse:false, cinematic:true,
  ...
  // 256 particles in swarm. Pure noise and texture. Not music — sonification.
  {
    ...
    harmonyMode:'free',
    particleGlow:.8, trailLen:0, lens:'Events', bgPulse:true, cinematic:true,
  ...
  // Meditation physics — noise and texture as meditation. Anti-music zen.
  {
    ...
    harmonyMode:'free',
    particleGlow:2.5, trailLen:0, lens:'Tension', bgPulse:false, cinematic:true,
  ...
  // Chaos + explosion alternating. Musical thunderstorm.
  {
    ...
    harmonyMode:'dissonant',
    particleGlow:1.5, trailLen:0, lens:'Events', bgPulse:true, cinematic:true,
  ...
  // Revolution — musical tension builds and releases in 3/4 feel.
  {
    ...
    harmonyMode:'modal',
    particleGlow:1.5, trailLen:0, lens:'Tension', bgPulse:false, cinematic:true,
  ...
  // Empty starting point — no particles, no gates. You build everything.
  {
    ...
    harmonyMode:'consonant',
    particleGlow:1.5, trailLen:0, lens:'Notes', bgPulse:false, cinematic:false,
